        ...
        <div className="space-y-6">
          <Tabs defaultValue="database" value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-1">
              <TabsTrigger value="database"><h3 className="text-md font-bold">Select/Enter Vehicle Details</h3></TabsTrigger>
            </TabsList>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm text-zinc-400">
                ...
                <div>
                  ...
                  {gasDetails ? `${gasDetails.year} ${gasDetails.make} ${gasDetails.model}` : "Custom Gas Vehicle"}
                </div>
              </div>

              {/* Total Cost Comparison */}
              <div className="space-y-2">
                <h3 className="text-lg font-semibold">Total Cost of Ownership (Over {yearsOwned} Years)</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-logo-blue/10 border border-logo-blue/20">
                    <div className="text-sm text-zinc-400 mb-1">Electric Vehicle</div>
                  ...
                  <div className="p-4 rounded-lg bg-zinc-800/50 border border-zinc-700/20">
                    <div className="text-sm text-zinc-400 mb-1">Gas Vehicle</div>
                    <div className="text-2xl font-bold text-white">
              ...
              <div className="p-4 rounded-lg bg-gradient-to-r from-logo-blue/20 to-logo-blue/5 border border-logo-blue/20">
                ...
                <div className={`text-2xl font-bold ${results.savings > 0 ? "text-green-400" : "text-red-400"}`}>
                  ${Math.round(results.savings).toLocaleString()}
                </div>
                {results.yearsToBreakEven < 100 && (
                  <div className="text-sm text-zinc-400 mt-1">
                    Break-even in approximately {results.yearsToBreakEven} years
                  </div>
                )}
              </div>
              ...
              <div className="p-4 rounded-lg bg-green-900/20 border border-green-900/30">
                ...
                <div className="text-sm text-zinc-400 mt-1">
                  Equivalent to planting approximately {Math.round(results.co2Savings * 16.5)} trees
                </div>
              </div>
